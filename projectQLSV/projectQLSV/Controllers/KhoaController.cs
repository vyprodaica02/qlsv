...
namespace projectQLSV.Controllers
{
    ...
    {
        private readonly KhoaServices<Khoa> repository;
        private readonly AppDbContext _dbContext;

        public KhoaController(KhoaServices<Khoa> userRepository, AppDbContext dbContext)
        {
        ...
        public async Task<IActionResult> Add(Khoa khoa)
        {
            ...
            await repository.AddAsync(khoa);
            return Ok("oke");
        }
        ...
        [HttpPut("UpdateAsync")]
        public async Task<IActionResult> UpdateUse(Khoa khoa)
        {
            if (khoa == null)
            {
                return BadRequest("Lỗi");
            ...
            {
                await repository.UpdateAsync(khoa);
                return Ok("oke");
