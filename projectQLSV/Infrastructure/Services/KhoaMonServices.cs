...
{
    public class KhoaMonServices<T> : IRepository<T> where T : KhoaMon
    {
        private DbSet<T> _services;
        private readonly AppDbContext dbContext;
        public KhoaMonServices(AppDbContext dbContext)
        {
        ...
        {
            var userHt = dbContext.khoaMons.FirstOrDefault(x => x.Id == id);
